	...
	public void selectLoc() {
		...
		switch(selectedLoc) 
		{
			case 0: 
				...
				break;
			default: 
				if(locations[selectedLoc-1] instanceof Cave && Game.player.inventory.hasFood() || locations[selectedLoc-1] instanceof Forest && Game.player.inventory.hasWood() || locations[selectedLoc-1] instanceof River && Game.player.inventory.hasWater())
				{
